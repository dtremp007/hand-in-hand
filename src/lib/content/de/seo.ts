...
export const seo: SeoContent = {
	'/': {
		title: 'Vertrauliche, im Glauben verwurzelte Unterstützung',
		description:
			'Du musst einen stillen Kampf nicht allein führen. Hand In Hand verbindet dich mit vertrauenswürdiger, vertraulicher, im Glauben verwurzelter Unterstützung.'
	},
	'/about': {
		title: 'Über unseren Dienst',
		description:
	...
	'/register': {
		title: 'Registrieren',
		description: 'Erstelle mit einem Einladungscode ein privates Hand-In-Hand-Administratorkonto.'
	}
};
